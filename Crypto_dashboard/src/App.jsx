...
function BrandWordmark({ className = '' }) {
  return (
    <div className={cn('select-none leading-none', className)}>
      <span className="text-slate-900 [text-shadow:0_1px_0_rgba(255,255,255,0.65)] dark:text-slate-100 dark:[text-shadow:none]">
        Crypto
      </span>
...
export default function App() {
  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 py-6 sm:px-6 lg:px-8 light:bg-white">
        <header className="rounded-[28px] border border-white/8 bg-slate-950/65 px-5 py-6 shadow-soft backdrop-blur-sm light:rounded-[32px] light:border-slate-100 light:bg-white light:shadow-[0_18px_48px_-28px_rgba(15,23,42,0.18)] sm:px-7">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl">
              <p className="text-sm uppercase tracking-[0.22em] text-emerald-300 light:text-emerald-600">
                Real-time market pulse
              </p>
              <BrandWordmark className="mt-3 text-5xl font-semibold tracking-tight sm:text-6xl" />
        ...
        <footer className="mt-8 border-t border-white/8 py-6 text-center text-sm text-slate-400 light:border-slate-100 light:text-slate-500">
          <BrandWordmark className="mx-auto text-3xl font-semibold tracking-tight" />
